    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="${resourcesPath}/images/carousel/slide1.jpg" alt="Slide" title="Some text" >
            </div>
            <div class="item">
                <img src="${resourcesPath}/images/carousel/slide2.jpg" alt="Slide" title="Some text" >
            </div>
            <div class="item">
                <img src="${resourcesPath}/images/carousel/slide3.jpg" alt="Slide" title="Some text" >
            </div>
            <div class="item">
                <img src="${resourcesPath}/images/carousel/slide4.jpg" alt="Slide" title="Some text" >
            </div>
        </div>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <img class="img-rounded" src="${resourcesPath}/images/movies/estreno1.png" alt="Generic placeholder image" width="150" height="200">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <img class="img-rounded" src="${resourcesPath}/images/movies/estreno2.png" alt="Generic placeholder image" width="150" height="200">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <img class="img-rounded" src="${resourcesPath}/images/movies/estreno3.png" alt="Generic placeholder image" width="150" height="200">
                <h4>Fragmentado</h4>
                <h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <img class="img-rounded" src="${resourcesPath}/images/movies/estreno4.png" alt="Generic placeholder image" width="150" height="200">
